 ...
 * @author Stephan
 */
public class ShowVendors extends ShowTablePanel implements LigaSelectable {
    ...
    private void initComponents() {
        ...
        JLabel showGroupsLeagueLabel = new JLabel();

        JPanel tablePanel = new JPanel();
        JScrollPane jScrollPane1 = new JScrollPane();
        jTable1 = new javax.swing.JTable();
//        jTable1.setAutoCreateRowSorter(true); // dadurch ist die Selektion nicht korrekt
        ...
        jTable1.setName("Table_Automatenaufsteller");
